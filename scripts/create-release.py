...
if __name__ == '__main__':
    ...
    __version__ = None
    with open(os.path.join(LIB_DIR, 'rss_podcast_downloader', '__init__.py'), 'rb') as f:
        exec(f.read())
    ...
    for directory in ['rss_podcast_downloader.egg-info', 'dist', 'build', 'rss-podcast-downloader-%s' % __version__]:
